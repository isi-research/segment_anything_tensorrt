...
if __name__ == "__main__":
    ...
    parser.add_argument("--embedding_engine_file", type=str, default="weights/sam_default_embedding.engine")
    ...
    print("<<<prompt mask tensors shapes>>>")
    print("image_embeddings: {} dtype = {}".format(image_embedding.shape, image_embedding.dtype))
    print("point_coords: {} dtype = {}".format(onnx_coord.shape, onnx_coord.dtype))
    print("point_labels: {} dtype = {}".format(onnx_label.shape, onnx_label.dtype))
    print("mask_input: {} dtype = {}".format(onnx_mask_input.shape, onnx_mask_input.dtype))
    print("has_mask_input: {} dtype = {}".format(onnx_has_mask_input.shape, onnx_has_mask_input.dtype))
